var ddaccordion={
	...
	jQuery(document).ready(function($){
		...
		config.htmlsetting={location: config.togglehtml[0], collapse: "<img src='"+config.togglehtml[1]+"' class='statusicon' alt='collapse/>'", expand: "<img src='"+config.togglehtml[2]+"' class='statusicon' alt='expand'/>"} //store HTML settings as object properties
